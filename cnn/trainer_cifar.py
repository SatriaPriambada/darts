...
async def per_res_train(device, 
    ...
    plt.savefig(path + '/train_cifar_{}_{}.pdf'.format(device, device_id), ext='pdf', bbox_inches='tight')
    plt.savefig(path + '/train_cifar_{}_{}.png'.format(device, device_id), ext='png', bbox_inches='tight')
