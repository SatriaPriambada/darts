...
def draw_histogram_graph(file_name, device, path):
    ...
    plt.savefig(
        save_name + ".pdf", ext="pdf", bbox_extra_artists=(lgd,), bbox_inches="tight"
    )
    plt.savefig(
        save_name + ".png", ext="png", bbox_extra_artists=(lgd,), bbox_inches="tight"
    )
    plt.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=str,
        default="arch_profile_imagenet_gpu-rtx2080.csv",
